    ...
    "English (US)": {
        ...
        keys: [
            ...
            [
                ...
                { keytype: "normal", label: "⌫", shape: "expand", keycode: 14 } // Backspace
            ],
            [
                { keytype: "normal", label: "↹", shape: "tab", keycode: 15 }, // Tab
            ...
            [
                { keytype: "normal", label: "⇪", shape: "caps", keycode: 58 }, // Caps Lock
                ...
                { keytype: "normal", label: "⏎", shape: "expand", keycode: 28 } // Enter
            ],
            [
                { keytype: "modkey", label: "⇧", labelShift: "⇧", labelCaps: "⇧", shape: "shift", keycode: 42 }, // Shift
                ...
                { keytype: "modkey", label: "⇧", labelShift: "⇧", labelCaps: "⇧", shape: "expand", keycode: 54 } // Shift
            ],
            [
                { keytype: "modkey", label: "Ctrl", shape: "control", keycode: 29 },
                { keytype: "modkey", label: "Alt", shape: "normal", keycode: 56 },
                { keytype: "normal", label: "", shape: "space", keycode: 57 }, // Space (Empty label)
                { keytype: "modkey", label: "Alt", shape: "normal", keycode: 100 },
                { keytype: "normal", label: "☰", shape: "normal", keycode: 139 }, // Menu
